...
<Highlight color="#ff2f00">重要</Highlight> 範例工程會使用 **Unity New InputSystem**，所以建議先安裝，否則會有 **EventSystem** 失效問題。
...
<Highlight color="#ff2f00">重要</Highlight> 有很多調用的方式，都可以參考 Samples，裡面都有完整的範例。

<Highlight color="#00d679">提醒</Highlight> 範例 GameView 皆為 **2K Portrait (w: 1080 * h: 1920)**。
