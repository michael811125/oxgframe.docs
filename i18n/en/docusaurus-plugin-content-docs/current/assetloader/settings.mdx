...
- Weak Host Mode (Weak Online Mode). Must be online for the first startup to complete initial configuration recording and resource download.
  - <Highlight color="#0373fc">Attention</Highlight>: Does not support Skip Download (download while playing). When internet is lost, it will verify the integrity of the manifest content of the last resource version.
