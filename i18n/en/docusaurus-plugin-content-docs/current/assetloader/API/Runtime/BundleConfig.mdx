...
### GetValueFromUrlCfg
Gets the specified key-value pair from the `CdnConfig.dat` deployment configuration file. Supports automatic detection of encryption status and decryption.
