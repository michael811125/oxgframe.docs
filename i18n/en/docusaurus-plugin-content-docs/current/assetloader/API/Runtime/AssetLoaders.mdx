...
* **ReleaseResourceAssets(int groupId)**: Releases all Resources assets in that group, still subject to reference counting.
* **ReleaseBundleAssets(int groupId)**: Releases all Bundle assets in that group, still subject to reference counting.
