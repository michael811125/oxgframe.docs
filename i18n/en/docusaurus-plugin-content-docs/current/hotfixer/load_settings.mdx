...
<Highlight color="#00d679">Reminder</Highlight> The `hotfixdllconfig.conf` file name and extension can be customized ([refer to configuration settings](https://oxgframe.ouhiyo.com/docs/getting-started#hotfixsettings)).
